...
Connection conn;
 ...
 i=st.executeUpdate("insert into lease_shop(shop_id,address_line1,address_line2,city,pincode,state,shop_size,godown,furniture,duration,rent,username) values('0','"+line1+"','"+line2+"','"+city+"','"+pincode+"','"+state+"','"+size+"','"+godown+"','"+furniture+"','"+contract+"','"+rent+"','"+user+"')");
